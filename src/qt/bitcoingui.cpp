                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Condominium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Condominium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and condominium: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Condominium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Condominium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Condominium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Condominium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Condominium addresses"));
    ...
    openAction->setStatusTip(tr("Open a Condominium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Condominium Core help message to get a list with possible Condominium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Condominium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Condominium network", "", count));
}
...
{
    QString strTitle = tr("Condominium Core"); // default title

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Catalyst Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Catalyst address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and catalyst: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Catalyst Core"), this);
    aboutAction->setStatusTip(tr("Show information about Catalyst Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Catalyst"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Catalyst addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Catalyst addresses"));
    ...
    openAction->setStatusTip(tr("Open a Catalyst: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Catalyst Core help message to get a list with possible Catalyst command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Catalyst Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Catalyst network", "", count));
}
...
{
    QString strTitle = tr("Catalyst Core"); // default title
